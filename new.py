...
Hello, I am TalentScout Hiring assistant. I'll be helping you with your application today. 
...
Make them practical interview questions. Format as a numbered list. Be encouraging.{name_context}"""
    ...
    def process_message(self, user_input):
        ...
        if self.conversation_stage == "greeting":
            ...
            # Save the user's answers to technical questions
...
Great! I have all your information."""
    ...
    def save_candidate_data(self):
        ...
        filename = f"candidates/{candidate_id}.json"
        try:
            with open(filename, "w") as f:
                json.dump(self.candidate_info, f, indent=2)
        except Exception as e:
